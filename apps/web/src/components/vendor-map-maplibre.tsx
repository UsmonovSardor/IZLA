...
import { TASHKENT, BRAND, TEAL, VIOLET, esc, type MapLabels, type VendorMapProps } from './vendor-map-shared';
...
export function MapLibreVendorMap({ vendors, selectedId, hoveredId, onSelect, labels, className }: Props) {
