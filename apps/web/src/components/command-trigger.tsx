  ...
  return (
    <>
      ...
      <button
        onClick={openPalette}
        aria-label={t('open')}
        className="hidden items-center gap-2 rounded-full border border-line bg-white/70 px-3 py-1.5 text-sm text-slate2 transition hover:border-brand-200 hover:text-brand lg:inline-flex"
      >
        <Search size={15} />
        <span>{t('open')}</span>
